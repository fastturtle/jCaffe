...
$(JAVA$(PROJECT)_SO): $(JAVA$(PROJECT)_SRC)
	...
	@ echo
	mkdir -p lib
	javac -d . src/edu/h2r/jNet.java src/edu/h2r/jSolver.java src/edu/h2r/Disposable.java src/edu/h2r/JniException.java
	cp src/edu/h2r/jNet.java edu/h2r/
	cp src/edu/h2r/jSolver.java edu/h2r/
	cp src/edu/h2r/Disposable.java edu/h2r/
	cp src/edu/h2r/JniException.java edu/h2r/
